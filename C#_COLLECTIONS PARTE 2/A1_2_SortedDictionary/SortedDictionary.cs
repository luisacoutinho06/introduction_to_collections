...
namespace A1._2_SortedDictionary
{
    class SortedDictionary
    {
        static void Main(string[] args)
        {
            ...
            // Apresentando nova coleção chamada de SortedDictionary (um dicionário ordenado, ou seja é uma lista com mais agilidade ao retirar e colocar novos elementos, e as chaves se ordenam automaticamente, você inserindo ou não um valor):
            // Para visualizar a implementação do SortedDictionary é só selecioná-lo e apertar as teclas ALT + F12:
